    ...
    function html5Upload() {	
		...
		var setDomain = '';
		if( document.domain.toLowerCase().indexOf('www') > -1 ){
			setDomain = 'http://www.kfbd.co.kr'; 
		}else{
			setDomain = 'http://kfbd.co.kr'; 
		}
    	sUploadURL= setDomain + '/_smarteditor/popup/quick_photo/FileUploader_html5.asp'; 	//upload URL
 	...
 	function callFileUploader (){
		...
		if( document.domain.toLowerCase().indexOf('www') > -1 ){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : setDomain+'/_smarteditor/popup/quick_photo/FileUploader.asp',	//샘플 URL입니다.
