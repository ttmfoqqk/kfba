...
Dim dev_LastName  : dev_LastName = RequestSet("dev_LastName","POST","")
Dim dev_FirstName : dev_FirstName = RequestSet("dev_FirstName","POST","")
Dim dev_PhotoName : dev_PhotoName = RequestSet("dev_PhotoName","POST","")
...
Dim importFile   : importFile  = "dev_write.html"
...
Select Case applicationKey
    ...
    Case 57
        programName = "칵테일조주사"
		programTitleImg = "02"
		importFile      = "dev_write_noClass.html"
    Case 58
        programName = "믹솔로지스트"
		programTitleImg = "03"
	Case 59
	...
	Case 61
        programName = "외식경영관리사"
		programTitleImg = "06"
		importFile      = "dev_write_noClassKind.html"
	Case 62
        programName = "식음료관리사"
		programTitleImg = "07"
		importFile      = "dev_write_noClassKind.html"
...
ntpl.tplAssign array(   _
	...
	,array("LastName", IIF( FI_LastName="" , dev_LastName , FI_LastName ) ) _
	,array("FirstName", IIF( FI_FirstName="" , dev_FirstName , FI_FirstName ) ) _
	,array("PhotoName", dev_PhotoName ) _
